      ...
      <article className="lh-copy">
        <section className={nestedCopySelector}>
          ...
          <p>
            ...
            excited about the our work. Being able to explore different ideas
            and actuall make things while doing this exploring is one of the
            reasons I personally love web development so much.
          </p>
          <p>
            Even though I really enjoy working on these side projects, they can
            sometimes be really difficult to deal with. Every step of the
            process I find difficult to go through with.
          </p>
          ...
          <p>
            ...
            third are by and far the most difficult steps to actually
            accomplish. Coming up with a fresh and new idea to implement is the
            second hardest thing I do as a web developer (the first is
            vertically centering things in IE8-11 😄). I consistently need to
            fall back to helpful repos like this one{' '}
            <a
            ...
            know that articles about side projects outnumber the actual number
            of side projects about 30 to one.
          </p>
          <p>
        ...
        <section className={nestedCopySelector}>
          ...
          <p>
            ...
            need for me personally to have a really strict cutoff between work
            and personal time and so far it has worked out alright. But now that
            I am building projects with the same technology that I build my side
            projects with it gets increasingly difficult to notice the
          ...
          <p>
            ...
            push it out in its current state then let it sit here in my editor
            and collect digital dust I will leave you the reader with this:
          </p>
          <ul
            className={css`
          ...
          >
            ...
            <li>
              Work on things that interest you truly, not just things that are
              the new hot shit
            </li>
